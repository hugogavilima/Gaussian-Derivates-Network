...
class Betsy(tf.keras.Model):
  ...
  def __init__(self, input_shape, input_sigmas, input_kernel_size):
    ...
    # GAUSSIAN LAYERS
    ###################################################################
    self.gaussian1 = FTGDConvLayer(filters=64, 
    ...
    self.gaussian2 = FTGDConvLayer(filters=64, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian3 = FTGDConvLayer(filters=128, 
                                   kernel_size = input_kernel_size,  
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian4 = FTGDConvLayer(filters=128, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian5 = FTGDConvLayer(filters=256, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian6 = FTGDConvLayer(filters=256, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian7 = FTGDConvLayer(filters=256, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian8 = FTGDConvLayer(filters=512, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian9 = FTGDConvLayer(filters=512, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian10 = FTGDConvLayer(filters=512, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian11 = FTGDConvLayer(filters=512, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian12 = FTGDConvLayer(filters=512, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian13 = FTGDConvLayer(filters=512, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian14 = FTGDConvLayer(filters=256, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian15 = FTGDConvLayer(filters=128, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
    ...
    self.gaussian16 = FTGDConvLayer(filters=64, 
                                   kernel_size = input_kernel_size, 
                                   num_basis= 1, 
                                   order=2, 
                                   separated = False,
